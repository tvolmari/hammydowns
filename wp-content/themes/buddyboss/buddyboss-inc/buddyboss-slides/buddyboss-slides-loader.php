...
function buddyboss_slides_assets()
{
    if ( !is_admin() ) { // no loading in the dashboard
        ...
        wp_enqueue_style( 'buddyboss-slides-main', get_template_directory_uri() . '/buddyboss-inc/buddyboss-slides/css/buddyboss-slides.css', array( 'fontawesome', 'googlefonts' ), '3.1.7', 'all' );

        // Adds JavaScript for the image slider.
        wp_enqueue_script( 'buddyboss-slides-fwslider', get_template_directory_uri() . '/buddyboss-inc/buddyboss-slides/js/fwslider.min.js', array('jquery'), '1.0', true );
