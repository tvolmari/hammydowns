...
function buddyboss_customizer_live_preview() {
    ...
    wp_enqueue_script( 'buddyboss-theme-customizer', get_template_directory_uri() . '/buddyboss-inc/buddyboss-customizer/js/buddyboss-customizer.js', array( 'jquery', 'customize-preview' ), '3.1.7', true );
...
function buddyboss_customize_register( $wp_customize ) {
	...
	$wp_customize->add_section( 'buddyboss_logo_section' , array(
		...
		// Logo Upload
		$wp_customize->add_setting('buddyboss_logo' )->transport = 'postMessage';
