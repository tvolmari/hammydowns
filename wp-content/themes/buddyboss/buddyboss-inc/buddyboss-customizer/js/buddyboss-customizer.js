        ...
        wp.customize( 'boss_icon_color', function( value ) {
            value.bind( function( to ) {
                ...
                if ( $(window).width() > 721) {
                    ...
                    $( '#buddyboss-pics-add-photo-button' ).css( 'color', to );
                }
            });
        });
    }( jQuery ));
