...
class wpmp_html{
    ...
    function product_price(){
        ...
        $cart_enable = apply_filters("wpmp_cart_enable", $cart_enable,$post->ID);
        //$cart_enable...
        ...
        $prices = <<<PRICE
        <form method="post" action="{$home}" name="cart_form" class="cart_form">
...
PRICE;
        ...
        if($sales_price>0 && $expire == false && $base_price>$sales_price) $price_html = "<sub><strike>{$currency_sign}{$price_html}</strike></sub> ".$currency_sign.number_format($sales_price,2,".","");
        else $price_html = $currency_sign.$price_html;
        if($base_price==0) $price_html = __('Free', 'wpmarketplace');
        $prices.='<li class="wpmp-regular-price">'.$prices_text .'<h3>'.$price_html.'</h3></li>';
        if($price_variation){
        ...
        $prices.='<li><div class="clearboth"></div><div class="add-to-cart-button"><button '.$cart_enable.' class="btn btn-success" type="submit" id="cart_submit"><i class="glyphicon glyphicon-shopping-cart icon-shopping-cart icon-white"></i> '.__("Add to Cart","wpmarketplace").'</button></div></li>';         
...
PRICE;
        ...
        $prices.='<li><div class="clearboth"></div><div class="add-to-cart-button"><button '.$cart_enable.' class="btn btn-danger" type="submit" ><i class="glyphicon glyphicon-shopping-cart icon-shopping-cart icon-white"></i> '.__("Add to Cart","wpmarketplace").'</button></div></li>';         
