...
if(!empty($data)) {
    ...
    <tr id="sales_price">
        <td><abbr title="<?php echo __('If product has a discounted price which is lower then regular price (base price)','wpmarketplace'); ?>" ><?php echo __('Sales Price','wpmarketplace'); ?></abbr></td>
        <td><input type="text" size="16" id="price_labe" name="wpmp_list[sales_price]"  value="<?php if(isset($sales_price))echo number_format((double)$sales_price,2,'.','');?>"></td>
    </tr>
    <tr id="sales_expire">
        <td><label for="sales_expire1"><?php echo __('Sales Price Expire Date: ', 'wpmarketplace'); ?></label></td>
        <td>
    ...
    <tr id="wpmp-variation"><td><input type="checkbox" <?php if(isset($price_variation)) echo "checked='checked'"; else echo "";?> name="wpmp_list[price_variation]" id="price_variation" name="price_variation"> Variation</td></tr>       
    </table>
...
?>
            <tr id="voption<?php echo $optionkey;?>"><td><input type="text" name="wpmp_list[variation][<?php echo $key;?>][<?php echo $optionkey;?>][option_name]"  placeholder="option name" value="<?php echo $optionval['option_name'];?>"></td><td><input type="text" name="wpmp_list[variation][<?php echo $key;?>][<?php echo $optionkey;?>][option_price]" id="" size="5" placeholder="price" value="<?php echo $optionval['option_price'];?>"></td><td><img class="delet_voption" rel="voption<?php echo $optionkey;?>" title="delete this option" src="<?php echo plugins_url("wpmarketplace");?>/images/remove.png" alt=""></td></tr>
         <?php
            }
        }
    }
...
?>
         ...
         <tr>
             <td><label><?php echo __("Multiple Select:","wpmarketplace"); ?></label></td>
             <td><input type="checkbox" name="wpmp_list[variation][1][multiple]" placeholder="<?php echo __("Multiple Select:","wpmarketplace"); ?>"></td>
         </tr>
         <tr>
         ...
         <tr id="voption1">
             ...
             <td><input type="text" name="wpmp_list[variation][1][1][option_price]" size="5" id="" placeholder="price"></td>
...
?>
      ...
      <div style="width: 50%; float: left;" id="wpmp_discount">
