		...
		$auction_count = 0;
			...
			?>
			 <div class="wdm-single-auction-wrap">
				...
				<a href="<?php echo get_permalink($wdm_single_auction->ID); ?>" class="wdm-auction-sidebar-auc-link"><img src="<?php echo $auc_thumb; ?>" width="50" height="50" alt="<?php echo $wdm_single_auction->post_title; ?>" /></a>
				<?php //} ?>
			    </div>
			    <div class="wdm-auction-content">
			    <div class = "wdm_auction_sidebar_auc_title">
				<?php //if(!empty($get_link)){ ?>
				<a href="<?php echo get_permalink($wdm_single_auction->ID); ?>" class="wdm-auction-sidebar-auc-link"><?php echo $wdm_single_auction->post_title; ?></a>
				<?php //} ?>
			    </div>
