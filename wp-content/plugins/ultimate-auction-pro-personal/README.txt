...
== Changelog ==
= 4.5.2 =
* Fix - Paypal invoice not authenticated for https websites.


= 4.5.1 = 
* Fix - Buy Now transactions were showing warning messages. This has been fixed now.
* Fix - Added a code to get rid of auto <p> tag insertion by plugins like wp seo on certain themes.


= 4.5.0 =
* New Feature - Paypal config needed for users when they added auction has now been removed and they now dont need to configure return url and PDT inside their paypal account.
* New Feature - Share your auctions on social sites. Now, auctions have permalink which would enable them to share auction title on social sites. Read blog for more info - http://auctionplugin.net/how-to-social-share-your-auctions/
* New Feature - Admin can now disable/enable payments for sellers.
* New Feature - New email for rejecting best offer.
* Fix - Enable/Disable for email functionality 
