							...
							if ( is_user_logged_in() ) {
								...
								if ( $check_method == 'method_paypal' ) {
									...
									//} /*elseif ( $comm_inv == 'Yes' && ( ! in_array( 'administrator', $auction_author->roles )) ) {*/
										...
										//require('ua-paypal-invoice/ua-paypal-adaptive.php');
										$buy_now_link		 = "";
										//$auth_key = get_post_meta($wdm_auction->ID, 'wdm-auth-key', true);
			...
			$auction_data['pay_type'] = 'simple';
									...
									<div id="wdm_buy_now_section">
											...
											<div id="wdm-buy-line-above" >
												...
												if ( $adaptive_payment ) {
													echo $buy_now_link;
													require('ajax-actions/buy-now-adaptive.php');
												} else {
													?>
							...
							?>
								       ...
								       <?php //$ret_url = add_query_arg('wdm', $a_key, $ret_url);?>
									...
									<!--<script type="text/javascript">
										jQuery( document ).ready( function () {
											jQuery( "#wdm_buy_now_section form" ).click( function () {
												...
												jQuery( "#wdm_buy_now_section form input[name='return']" ).val( "<?php echo $ret_url; ?>" );
											} );
										} );
									</script>-->
									<?php
						...
						if ( is_user_logged_in() ) {
							...
							<div class="wdm-clear">
								...
								require('ajax-actions/add-to-watch.php'); //file to handle ajax request related to adding auction to watchlist
								?>
							</div>
							<?php
						} else {
