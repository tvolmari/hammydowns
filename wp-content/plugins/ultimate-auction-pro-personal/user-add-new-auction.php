...
for ($p = 1; $p <= 4; $p++) {
	...
	if ($p == 4) {
		$add_user_auction .= '<a href="" class="auction_fields_tooltip auction_fields_tooltip_atch" onclick="return false"><strong>' . __("?", "wdm-ultimate-auction") . '</strong>
...
'<input name="lowest_bid" type="text" id="lowest_bid" class="small-text number ua_auction_price_fields" value="' . $auc_set->wdm_post_meta('wdm_lowest_bid') . '"/>
	    <a href="" class="auction_fields_tooltip" onclick="return false" ><strong>' . __("?", "wdm-ultimate-auction") . '</strong>
