...
class BP_Member_Type_Actions {
	...
	public function register_post_type() {
		...
		register_post_type( bmt_get_post_type(), array(
			'label' 	=> __( 'BuddyPress Member Types', 'bmt-member-types' ),
			'labels' 	=> array(
	...
	public function bmt_member_type_on_registration( $user_id, $user_login, $user_password, $user_email, $usermeta ) {
		...
		$bmt_member_type = ! empty ( $usermeta['bmt_member_type'] ) ? $usermeta['bmt_member_type'] : buddyboss_bmt()->option('default_member_type');
