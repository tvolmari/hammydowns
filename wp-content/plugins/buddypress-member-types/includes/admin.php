...
class BuddyBoss_BMT_Admin {
	...
	*/
	...
	public function admin_init() {
		...
		add_settings_section( 'general_section', __( 'Registration Form', 'buddyboss-media' ), array( $this, 'section_general' ), __FILE__ );
	...
	public function admin_menu() {
		add_submenu_page(
                    $this->settings_page, 'BuddyPress Member Types', 'Options', $this->capability, $this->plugin_slug, array( $this, 'options_page' )
		);
	}
	...
	?>
            <div class="wrap">
                    <h1><?php _e( 'Options', 'bp-member-type' ); ?></h1>
	...
	public function setting_hide_member_type_field() {
		...
		_e( 'Remove member type selection from Registration Form.', 'bp-member-type' );
	}
	...
	public function setting_registration_required_field() {
		...
		_e( 'Require member type selection in Registration Form.', 'bp-member-type' );
	}
